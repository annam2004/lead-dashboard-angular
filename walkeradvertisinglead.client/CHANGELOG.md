...
- Create Angular project with ng: `ng new walkeradvertisinglead.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`walkeradvertisinglead.client.esproj`).
